...
public class FriendServiceImpl implements FriendService {
    ...
    public void sendRequest(Integer userId, Integer targetUserId) {
        ...
        if (userFriendRepository.existsByIdUserIdAndIdFriendIdAndStatus(userId, targetUserId, FriendStatus.PENDING)) {
            throw new BusinessException(HttpStatus.CONFLICT, "Lời mời kết bạn đã tồn tại");
        }

        if (userFriendRepository.existsByIdUserIdAndIdFriendIdAndStatus(targetUserId, userId, FriendStatus.PENDING)) {
